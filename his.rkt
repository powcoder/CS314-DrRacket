...
(define (func2 func numrows numcols)
                                     (lambda (row col)
...
(define (repeat-rows nrepeat figure)
  (make-figure (lambda (row col)((figure-func figure)(modulo row (figure-numcols figure))))
  )	(figure-numrows figure) 
        (* nrepeat (figure-numcols figure)))
...
(define (append-cols figurea figureb)
 (make-figure(figure-numcols figurea)(figure-numcols figureb)
  (lambda(row col)
...
(define (append-rows figurea figureb)
  (make-figure(figure-numrows figurea)(figure-numrows figureb)
 (lambda(row col)
   (if(>(figure-nums figurea)row)
      ((figure-func figurea)row col)
...
(define (flip-cols figure)
 (make-figure
  (lambda(row col)
    ((figure-func figure)
     row
     (-(figure-numcols figure)(+ col 1))))(figure-numcols figure)
  (figure-numrows figure)))
...
(define (flip-rows figure)
  ...
  (lambda(row col)
    ((figure-func figure)
     row
     (-(figure-numcols figure)(+ row 1))col))))
